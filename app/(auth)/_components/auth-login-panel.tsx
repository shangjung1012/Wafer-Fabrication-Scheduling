...
type AuthLoginPanelProps = {
  title: string;
  loginEndpoint: "/api/auth/login" | "/api/auth/login-demo";
  postLogoutPath: PostLogoutLoginPath;
...
export function AuthLoginPanel({
  ...
  const usernamePlaceholder =
    quickAccounts.length > 0 ? "SA-1 or sa-1@mail.com" : "Username or email";
