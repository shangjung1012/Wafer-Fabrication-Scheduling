 ...
 *
 * POST /api/conflicts/:id/resolve — admin applies optional proposal changes
 * and returns the order to PENDING for rescheduling.
 *
 * Body:
 *   applyProposal { newDueDate?, newQuantity? } (optional)
...
import { resolveConflict } from "@/modules/order/conflict-service";
...
export async function POST(
  ...
  try {
    ...
    await resolveConflict(ctx, prisma, id, parsed.data);
